...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        long expectedProduct = 12345678 * 56781234;
        long end = System.currentTimeMillis();
        long timeElapsed = end - start;
        System.out.println("Sequential time : "+ timeElapsed +" milliseconds");

        start = System.currentTimeMillis();
        long actualProduct = mult(12345678, 56781234);
        end = System.currentTimeMillis();
        timeElapsed = end - start;
        System.out.println("Parallel time : "+ timeElapsed +" milliseconds");
        ...
        start = System.currentTimeMillis();
        expectedProduct = 102102102 * 313313313;
        end = System.currentTimeMillis();
        timeElapsed = end - start;
        System.out.println("Sequential time : "+ timeElapsed +" milliseconds");

        start = System.currentTimeMillis();
        actualProduct = mult(102102102, 313313313);
        end = System.currentTimeMillis();
        timeElapsed = end - start;
        System.out.println("Parallel time : "+ timeElapsed +" milliseconds");
        ...
        start = System.currentTimeMillis();
        expectedProduct = 13451234 * 63456123;
        end = System.currentTimeMillis();
        timeElapsed = end-start;
        System.out.println("Sequential time : "+ timeElapsed +" milliseconds");

        start = System.currentTimeMillis();
        actualProduct = mult(13451234, 63456123);
        end = System.currentTimeMillis();
        timeElapsed = end - start;
        System.out.println("Parallel time : "+ timeElapsed +" milliseconds");
